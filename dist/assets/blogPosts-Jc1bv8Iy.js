const o=[{id:"residential",name:"Residential Cleaning",description:"Tips and tricks for keeping your home spotless",color:"bg-blue-500",icon:"🏠"},{id:"commercial",name:"Commercial Cleaning",description:"Professional cleaning strategies for businesses",color:"bg-green-500",icon:"🏢"},{id:"eco-friendly",name:"Eco-Friendly",description:"Green cleaning solutions and sustainable practices",color:"bg-emerald-500",icon:"🌿"},{id:"deep-cleaning",name:"Deep Cleaning",description:"Intensive cleaning methods and seasonal maintenance",color:"bg-purple-500",icon:"✨"},{id:"organization",name:"Organization",description:"Decluttering and organizing tips for a tidy space",color:"bg-orange-500",icon:"📦"},{id:"maintenance",name:"Maintenance",description:"Regular upkeep and preventive cleaning strategies",color:"bg-red-500",icon:"🔧"}],r=[{id:"ultimate-spring-cleaning-checklist",title:"The Ultimate Spring Cleaning Checklist for Niagara Homes",excerpt:"Transform your home this spring with our comprehensive room-by-room cleaning guide. Perfect for St. Catharines and Niagara Falls residents.",content:`
...
<p>Spring cleaning doesn't have to be overwhelming. Break it down room by room, and consider professional help for the heavy-duty tasks. Your Niagara home will feel fresh and renewed for the warmer months ahead!</p>
    `,author:"VIP Cleaning Squad",publishedDate:"2024-03-15",readTime:8,category:"residential",tags:["spring cleaning","checklist","home maintenance","niagara","deep cleaning"],image:"/api/placeholder/800/400",seoTitle:"Ultimate Spring Cleaning Checklist for Niagara Homes | VIP Cleaning Squad",metaDescription:"Complete spring cleaning guide for St. Catharines and Niagara Falls homes. Room-by-room checklist from professional cleaners. Book VIP Cleaning Squad today!",featured:!0},{id:"eco-friendly-cleaning-products-guide",title:"10 Eco-Friendly Cleaning Products That Actually Work",excerpt:"Discover powerful green cleaning solutions that are safe for your family and the environment. Tested and approved by cleaning professionals.",content:`
...
<p>Transitioning to eco-friendly cleaning doesn't have to happen overnight. Start by replacing one conventional product at a time, and always read labels carefully. Look for certifications like EPA Safer Choice or Green Seal.</p>
    `,author:"Sarah Chen, VIP Cleaning Specialist",publishedDate:"2024-03-10",readTime:6,category:"eco-friendly",tags:["eco-friendly","green cleaning","natural products","DIY","health"],image:"/api/placeholder/800/400",seoTitle:"10 Eco-Friendly Cleaning Products That Work | Green Cleaning Guide",metaDescription:"Discover effective eco-friendly cleaning products and DIY recipes. Safe for family and pets. Professional green cleaning tips from VIP Cleaning Squad.",featured:!0},{id:"commercial-office-cleaning-best-practices",title:"Commercial Office Cleaning: Best Practices for a Productive Workspace",excerpt:"Learn how proper office cleaning affects employee productivity and health. Essential strategies for maintaining a professional work environment.",content:`
...
<p>Contact VIP Cleaning Squad today for a free commercial cleaning consultation. We'll assess your space and provide a customized cleaning plan that fits your budget and schedule.</p>
    `,author:"Mike Rodriguez, Commercial Cleaning Manager",publishedDate:"2024-03-08",readTime:9,category:"commercial",tags:["commercial cleaning","office cleaning","productivity","business","professional"],image:"/api/placeholder/800/400",seoTitle:"Commercial Office Cleaning Best Practices | Professional Workspace Maintenance",metaDescription:"Essential office cleaning strategies for productive workspaces. Professional commercial cleaning tips for Niagara businesses. Get quote from VIP Cleaning Squad.",featured:!1},{id:"deep-cleaning-vs-regular-cleaning",title:"Deep Cleaning vs Regular Cleaning: When Do You Need Each?",excerpt:"Understand the difference between deep cleaning and regular maintenance. Learn when to schedule each type for optimal home cleanliness.",content:`
...
<p>Contact VIP Cleaning Squad for a personalized consultation. We'll assess your home and lifestyle to recommend the ideal combination of regular and deep cleaning services.</p>
    `,author:"Jessica Thompson, Cleaning Coordinator",publishedDate:"2024-03-05",readTime:7,category:"deep-cleaning",tags:["deep cleaning","regular cleaning","home maintenance","cleaning schedule","professional cleaning"],image:"/api/placeholder/800/400",seoTitle:"Deep Cleaning vs Regular Cleaning: Complete Guide | VIP Cleaning Squad",metaDescription:"Learn the difference between deep cleaning and regular maintenance. When to schedule each type for optimal home cleanliness. Expert advice from VIP Cleaning Squad.",featured:!1},{id:"organize-your-home-before-cleaning",title:"How to Organize Your Home Before the Cleaners Arrive",excerpt:"Maximize your cleaning service value by properly preparing your home. Simple organization tips that make cleaning more efficient and thorough.",content:`
...
<p>Contact VIP Cleaning Squad today to discuss your cleaning needs. We'll provide personalized guidance on preparing your home and ensuring you get the best possible results from our service.</p>
    `,author:"Amanda Foster, Client Relations Manager",publishedDate:"2024-03-01",readTime:8,category:"organization",tags:["organization","cleaning preparation","home management","professional cleaning","efficiency"],image:"/api/placeholder/800/400",seoTitle:"How to Organize Your Home Before Cleaners Arrive | Preparation Guide",metaDescription:"Maximize your cleaning service value with proper home preparation. Room-by-room organization tips from VIP Cleaning Squad professionals.",featured:!1}],t=()=>r.filter(e=>e.featured),s=e=>r.filter(n=>n.category===e),l=e=>r.find(n=>n.id===e),g=()=>{const e=new Set;for(const n of r)for(const i of n.tags)e.add(i);return Array.from(e).sort()},c=e=>{const n=e.toLowerCase();return r.filter(i=>i.title.toLowerCase().includes(n)||i.excerpt.toLowerCase().includes(n)||i.tags.some(a=>a.toLowerCase().includes(n))||i.content.toLowerCase().includes(n))};export{t as a,r as b,o as c,g as d,l as e,s as g,c as s};
